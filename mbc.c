...
unsigned int reg_def[] = {	// -> convert to structure
	...
	// Register Index, Count Bytes, Response Type, Response Factor
	0x0010,  2, 1,  0,
    0x0012,  2, 1,  0,
    0x0014,  2, 1,  0,
 //             
...
//              
    0xF500,  2, 0, 1,
    0xF600,  0, 0, 1,				// ! Meter Number
    0xF700, 15, 0, 1,				// Tariff
	0xF800,  2, 0, 1,				// ! Baudrate
 //             
    0xFA01, 10, 4, -4,
    0xFB01, 10, 4, -4,
//
